...
parser.add_argument('--data_dir', default='/home/liuqixuan/datasets/coco/images', type=str, metavar='DIR',
                    help='path to where coco images stored') 
parser.add_argument('--mask_dir', default='/home/liuqixuan/datasets/coco/', type=str, metavar='DIR',
                    help='path to where coco images stored')    
parser.add_argument('--logdir', default='./logs', type=str, metavar='DIR',
                    help='path to where tensorboard log restore')                                       
parser.add_argument('--json_path', default='/home/liuqixuan/datasets/coco/COCO.json', type=str, metavar='PATH',
                    help='path to where coco images stored')                                      
